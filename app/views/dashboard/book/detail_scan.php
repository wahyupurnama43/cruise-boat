...
<div class="row wrapper border-bottom white-bg page-heading">
    <center>
        <h2> <strong> Scan Booking </strong></h2>
    </center>
</div>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a href="<?= BASEURL ?>dashboard/book_print/<?= $payment['orderNum'] ?>" id="print" class="btn btn-warning btn-xs with-tooltip" data-tooltip-content="PRINT BOARDING PASS DEPATURE">&nbsp;<i class="fas fa-print"></i>&nbsp;</a>
                        <?php if ($book['scheduleReturnID'] !== '0') : ?>
                            <a href="<?= BASEURL ?>dashboard/book_print_return/<?= $payment['orderNum'] ?>" id="printReturn" class="btn btn-success btn-xs with-tooltip" data-tooltip-content="PRINT BOARDING PASS RETURN">&nbsp;<i class="fas fa-print"></i>&nbsp;</a>
                        <?php endif; ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless">
                            ...
                            <tr>
                                ...
                                <td><?= date('d-m-Y', strtotime($book['depart'])) ?></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    if ($book['scheduleReturnID'] == '0' || $book['scheduleReturnID'] == '') {
                                        ...
                                        echo date('d-m-Y', strtotime($book['datereturn']));
                                    }
                                    ?>
                                </td>
                            </tr>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?= date('D, d-m-Y H:i:s A', strtotime($payment['dateCreate'])); ?>
                                </td>
                            </tr>
                            <tr>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            url: "<?= BASEURL ?>dashboard/scan_prosess/<?= $payment['orderNum'] ?>",
            type: 'POST',
            success: function(data) {
                if (data == "on depart") {
                    // console.log(document.querySelector('#print').click());
                    // setTimeout(function() {
                    document.querySelector('#print').click();
                    // window.location.href = '<?= BASEURL ?>dashboard/book';
                    // }, 1000);
                } else if (data == "on return") {
                    document.querySelector('#printReturn').click();
                }
            }
        });
