    ...
    <div class="wrapper">
        <form action="<?= BASEURL ?>home/create_book" id="wizard" method="POST" name="form_name" class="position-relative">
            ...
            <section>
                <?php
                $firstName = $lastName = "";
                if (isset($_SESSION['session_status']) && $_SESSION['session_login_grade_real'] == 'agent') {
                    $arr = explode(" ", $_SESSION['session_login']);
                    $firstName = $arr[0];
                    $i = 0;
                    if (count($arr) > 1) {
                        array_shift($arr);
                    ...
                    <div class="form-row ">
                        <div class="form-col">
                            ...
                            <div class="form-holder">
                                ...
                                <input type="text" class="form-control" name="namefirst" id="nameFisrt" required value="<?= $firstName ?>">
                            </div>
                        ...
                        <div class="form-col">
                            ...
                            <div class="form-holder">
                                <i class="fas fa-user-edit"></i>
                                <input type="text" class="form-control" name="namelast" id="nameLast" required value="<?= $lastName ?>">
                            </div>
                            <div class="invalid-feedback alert-form-8">
                                Please Complete The Data !!
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-col">
                            ...
                            <div class="form-holder">
                                ...
                                <input type="email" class="form-control" name="email" id="email" value="<?= $data['user']['userEmail'] ?>" required>
                            </div>
                    ...
                    <div class="form-col">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-col">
                                <div class="form-holder">
                                    <?php
                                    $ph = explode('62', $data['list_agent']['companyPhone']);
                                    ?>
                                    <input type="number" class="form-control" name="wa" id="wa" value="<?= $ph[1] ?>" required placeholder="Please use the format 812345678" style="padding-left: 10px;">
                                </div>
                                <div class="invalid-feedback alert-form-10">
                                    Please Complete The Data !!
                                </div>
            ...
            <section>
                ...
                <div class="ov-scroll">
                    ...
                    <div style="display: flex; justify-content: center; align-content: center; align-items: center;">
                        <input type="hidden" value="<?= $data['diskon']['diskon']; ?>" id="agent_user">
                        <input type="hidden" value="<?= $data['diskon']['diskon_internasional']; ?>" id="agent_user_internasional">
                        ...
                        <div class="d-flex gap-3 jscc" style="" id="list_payment">
                            ...
                            <?php if ($_SESSION['session_login_grade'] == "administrator" || ($_SESSION['method'] == "paylater")) :  ?>
                                <div class="d-flex">
                                    <input type="radio" name="payment" id="later" value="later">
                                    <label for="later" style="background: url('<?= ASSETS ?>/assets/payment/paylater.png'); background-size:cover; background-position:center; background-repeat:no-repeat;  width: 86px;height: 59px; "></label>
                                </div>
                            <?php endif; ?>
                            <?php Home::getSeatRegular();
                            ...
                            <?php endif;
                            if ($_SESSION['session_login_grade_real'] == "agent") : ?>
                                <div class="d-flex">
                                    <input type="radio" name="payment" id="cash" value="cash">
                                    <label for="cash" style="background: url('<?= ASSETS ?>/assets/payment/cash.png'); background-size:cover; background-position:center; background-repeat:no-repeat;  width: 86px;height: 59px; "></label>
                                </div>
        ...
        $(document).ready(function() {
            ...
            $('#above').change(function() {
                if (this.checked) {
                    ...
                    $('#passagerAdult1').val(nameFisrt + ' ' + nameLast);
                } else {
                    $('#passagerAdult1').val('');
                }
            })
